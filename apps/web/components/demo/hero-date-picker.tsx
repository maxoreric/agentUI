...
export function HeroDatePicker({ element }: ComponentRenderProps) {
  const { props } = element;
  ...
  const showMonthAndYearPickers = props.showMonthAndYearPickers as
    | boolean
    | undefined;
  const selectorIcon = props.selectorIcon as React.ReactNode;
